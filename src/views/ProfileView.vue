  ...
  <div v-if="user" class="taiga-show-container">
    ...
    <aside class="issue-sidebar">
      <div style="text-align: center; margin-bottom: 20px;">
        <img v-if="user.avatar_url" :src="user.avatar_url" style="width: 120px; height: 120px; border-radius: 50%; object-fit: cover; margin: 0 auto 15px auto; display: block; border: 2px solid #eee;" />
